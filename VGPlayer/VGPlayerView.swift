...
//        let pauseImage = VGPlayerUtils.imageResource("VGPlayer_ic_pause")
        ...
        let playImage = #imageLiteral(resourceName: "ic_play")
        let pauseImage = #imageLiteral(resourceName: "ic_pause")
        
        self.playButtion.setImage(VGPlayerUtils.imageSize(image: playImage, scaledToSize: CGSize(width: 70, height: 50)), for: .normal)
        self.playButtion.setImage(VGPlayerUtils.imageSize(image: pauseImage, scaledToSize: CGSize(width: 70, height: 50)), for: .selected)
